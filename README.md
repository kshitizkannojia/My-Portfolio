...
![Portfolio Preview](https://github.com/kshitizkannojia/My-Portfolio/blob/main/public/assets/projects-screenshots/portfolio/landing.png?raw=true)
...
1. **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/kshitizkannojia/My-Portfolio.git
    cd 3d-portfolio
    ```
...
If you use this portfolio, a credit or link back to the [original repo](https://github.com/kshitizkannojia/My-Portfolio) would be much appreciated ❤️
